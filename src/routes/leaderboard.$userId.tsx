      ...
      <div className="relative" style={{ filter: pending ? "none" : `drop-shadow(0 0 8px ${color}55)` }}>
        <svg width="88" height="88" viewBox="0 0 88 88">
          ...
          <circle cx="44" cy="44" r={r} fill="none" stroke={color} strokeWidth="7"
            ...
            transform="rotate(-90 44 44)" style={{ transition: "stroke-dasharray 0.8s cubic-bezier(.4,0,.2,1)" }} />
          <text x="44" y="47" textAnchor="middle" fontSize="15" fontWeight="800" fill="currentColor" letterSpacing="-0.5">{Math.round(pct)}%</text>
        </svg>
      </div>
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-[1600px] mx-auto px-3 sm:px-4 py-5 sm:py-8">
        ...
        {/* Accuracy circles */}
        {accuracy && (
          <div className="mb-6 rounded-2xl border border-border bg-gradient-to-b from-card to-card/60 p-6 flex flex-col items-center gap-4">
